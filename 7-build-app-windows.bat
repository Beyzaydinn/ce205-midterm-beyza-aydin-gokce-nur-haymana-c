...
call reportgenerator "-title:Event Library Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_lib_win.info" "-targetdir:docs/coverxygenlibwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_win"
...
call reportgenerator "-title:Event Library Test Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_test_win.info" "-targetdir:docs/coverxygentestwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_win"
...
echo Generate Test Coverage Data for Event
call OpenCppCoverage.exe --export_type=binary:event_tests_unit_win.cov --sources src\event\src --sources src\event\header --sources src\tests\event -- build_win\build\Debug\event_tests.exe

echo Generate Test Coverage Data for Event App and Combine Results
call OpenCppCoverage.exe --input_coverage=utility_tests_unit_win.cov --input_coverage=event_tests_unit_win.cov --export_type=cobertura:eventapp_unit_win_cobertura.xml --sources src\utility\src --sources src\utility\header --sources src\event\src --sources src\event\header --sources src\eventapp\src --sources src\eventapp\header --sources src\tests\utility --sources src\tests\event -- build_win\build\Debug\eventapp.exe

echo Generate Unit Test Coverage Report
call reportgenerator "-title:Event Library Unit Test Coverage Report (Windows)" "-targetdir:docs/coveragereportlibwin" "-reporttypes:Html" "-reports:**/eventapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/event/src;src/event/header;src/eventapp/src;src/eventapp/header;src/tests/utility;src/tests/event" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_win"
call reportgenerator "-targetdir:assets/codecoveragelibwin" "-reporttypes:Badges" "-reports:**/eventapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/event/src;src/event/header;src/eventapp/src;src/eventapp/header;src/tests/utility;src/tests/event" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
...
call robocopy src\event\header "build_win\build\Release" /E
call robocopy src\eventapp\header "build_win\build\Release" /E
...
call robocopy src\event\header "build_win\build\Debug" /E
call robocopy src\eventapp\header "build_win\build\Debug" /E
